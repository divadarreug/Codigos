...
#solo con la primera letra del nombre y de los apellidos en mayúscula. El usuario 
...
codp = input("Instroduce codigo de pais: ")
tel = input("Escribe numero de telefono: ")
ext = input("Escribe la Extension: ")
print("Tu numero es: ","+"+codp+"-"+tel+"-"+ext)
...
x = input("Escribe una frase: ")
y = input("Escribe una vocal: ")
print(x.replace(y, y.upper()))
...
x = input("Digite su correo electronico: ")
...
x = round(float(input("Escribe valor en euros: ")),2)
#1 = 100
y= (x*100)
print("El valor en euros es:",x,"El valor en centimos es:",y)
